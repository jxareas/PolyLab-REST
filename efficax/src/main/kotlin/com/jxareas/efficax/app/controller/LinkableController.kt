...
/**
 * The [LinkableController] interface represents a controller that follows the Hypermedia-driven RESTful API design.
 ...
 * @inheritdoc
 */
interface LinkableController<DTO, ID> : LinkBuilder<DTO> {
